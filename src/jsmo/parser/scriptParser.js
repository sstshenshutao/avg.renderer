...
import {
    ...
    Waittime,
    Woff
} from "../instruction/aliasInstruction.js";
...
function loadScript(scriptContext) {
    scriptIndex = 0;
    scriptBuffer = scriptContext.split('\n');
}
